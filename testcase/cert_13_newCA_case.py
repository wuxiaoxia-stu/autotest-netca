...
class NewCACase(Base):
    ...
    def test_cert_business_02(self):           
        ...
        self.InfoPage.getInfo(Base.newCAtemplate)
        self.InfoPage.submit_button()
        self.CheckPage.checkBusiness(False)
        self.assertIn('成功', self.CheckResultPage.tip_text())
        self.write_log('info', '用例13-证书续期完成')   
        self.CheckResultPage.continue_button()
    ...
    def test_cert_business_03(self):           
        ...
        self.assertIn('成功', self.CheckResultPage.tip_text())
        self.write_log('info', '用例13-证书密钥更新完成')   
        self.CheckResultPage.continue_button()
    ...
    def test_cert_business_04(self):           
        ...
        self.CheckPage.checkBusiness(True)
        self.assertIn('成功', self.CheckResultPage.tip_text())
        self.write_log('info', '用例13-证书变更完成')   
        self.CheckResultPage.continue_button()
    ...
    def test_cert_business_05(self):           
        ...
        self.write_log('info', '用例13-证书挂失完成')   
        self.CheckResultPage.continue_button()
    ...
    def test_cert_business_06(self):           
        ...
        self.CheckPage.checkBusiness(False)
        self.assertIn('成功', self.CheckResultPage.tipCheck_text())
        self.write_log('info', '用例13-证书解挂完成')   
        self.CheckResultPage.continue_button()
    ...
    def test_cert_business_09(self):           
        ...
        self.CheckPage.checkBusiness(True)
        self.assertIn('成功', self.CheckResultPage.tip_text())
        self.write_log('info', '用例13-电子密匙更换完成')   
        self.CheckResultPage.continue_button()
    ...
    def test_cert_business_10(self):           
        ...
        self.CheckPage.checkBusiness(False)
        self.assertIn('成功', self.CheckResultPage.tipCheck_text())
        self.write_log('info', '用例13-用户退订完成')   
        self.CheckResultPage.continue_button()       
    ...
    def test_cert_business_11(self):
        ...
        self.InfoPage.submit_button()
        self.CheckPage.checkBusiness(True)
        self.assertIn('2张证书已经安装成功', self.CheckResultPage.tip_text())
        self.write_log('info', '用例13-重新制证完成')   
        self.CheckResultPage.continue_button()
    ...
    def test_cert_business_12(self):
        ...
        self.CheckPage.checkBusiness(True)
        self.assertIn('2张证书已经安装成功', self.CheckResultPage.tip_text())
        self.write_log('info', '用例13-密钥恢复完成')
        self.CheckResultPage.continue_button()


    # 用例：密钥恢复（仅安装加密证书）
    def test_cert_business_13(self):
        self.BusinessPage.business_frame_out()
        self.MenuPage.deleteCert()
        self.BusinessPage.business_frame_in()
        self.BusinessPage.acceptBusiness('证书申请')
        self.InfoPage.addInfo('da测试项目', '110CA-SM2机构证书', '新CA业务回归' + Base.now)
        self.InfoPage.submit_button()
        self.CheckPage.checkBusiness(False)
        self.CheckResultPage.continue_button()
        self.CheckPage.back_button()

        self.BusinessPage.acceptBusiness('密钥恢复', 1)
        self.InfoPage.getInfo('110CA-SM2机构证书')
        self.InfoPage.submit_button()
        self.CheckPage.checkBusiness(True)
        self.assertIn('1张证书已经安装成功', self.CheckResultPage.tip_text())
        self.write_log('info', '用例13-密钥恢复（不安装签名证书）完成')
        self.CheckResultPage.continue_button()
